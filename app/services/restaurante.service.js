        ...
        execute: function() {
            RestauranteService = (function () {
                ...
                RestauranteService.prototype.addRestaurante = function (restaurante) {
                    ...
                    return this._http.post("http://133.100.1.180:81/curso-angular2-practica/api-rest/restaurantes-api.php/restaurantes", params, { headers: headers }).map(function (res) { return res.json(); });
                };
                RestauranteService.prototype.editRestaurante = function (restaurante) {
                    var json = JSON.stringify(restaurante);
                    var params = "json=" + json;
                    var headers = new http_1.Headers({ "Content-Type": "application/x-www-form-urlencoded" });
                    return this._http.post("http://133.100.1.180:81/curso-angular2-practica/api-rest/restaurantes-api.php/update-restaurante/" + restaurante.id, params, { headers: headers }).map(function (res) { return res.json(); });
                };
